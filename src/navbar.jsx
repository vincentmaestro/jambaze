...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-center py-5 tablet:gap-x-[3%] tablet_s:justify-between tablet_s:px-[5%] tablet_s:py-3 tablet_s:sticky tablet_s:top-0 z-10 tablet_s:bg-stone-600">
            ...
            <button className="rounded-[8px] bg-orange-500 text-white px-[8px] py-[5px] hover:bg-slate-800 transition-colors duration-200 hidden tablet_s:hidden light-mode" onClick={lightMode}><i className="fa-solid fa-sun" /> Light mode</button>
